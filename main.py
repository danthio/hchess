...
def main():
	...
	if con==1:
		...
		can.create_line(x_,y_+yy-40, x_+xx,y_+yy-40,fill="#333333")
		can.create_line(350,y_+yy-40, 350,y_+yy, fill="#333333")
...
def scale_difficulty():
	...
	can.create_oval(x+xx-3,y_+250-12, x+xx+3,y_+250-12+6,fill=col[0],outline=col[0])
	can.create_oval(x+xx-3,y_+250+12-6, x+xx+3,y_+250+12,fill=col[0],outline=col[0])
	can.create_rectangle(x+xx-3,y_+250-12+3, x+xx+3,y_+250+12-3,fill=col[0],outline=col[0])
...
def intro():
	...
	can.create_text(350,y_+30,text="Play aganist stockfish",font=("FreeMono",13),anchor="c",fill=col[0])
	...
	can.create_text(350,y_+220,text="Difficulty",font=("FreeMono",13),anchor="c",fill=col[0])


	can.create_line(x_+xv,y_+250, x_+xx-xv,y_+250,fill=col[0],width=2)
	...
	can.create_arc(xc-50+30,y_+300+40, xc-50+30+20,y_+300+40+20,start=90,extent=90,style="arc",outline="#333333")
	can.create_arc(xc-50+30,y_+300+100+30-20, xc-50+30+20,y_+300+100+30,start=180,extent=90,style="arc",outline="#333333")
	can.create_arc(555.875-20,y_+300+100+30-20, 555.875,y_+300+100+30,start=270,extent=90,style="arc",outline="#333333")
	can.create_arc(555.875-20,y_+300+40, 555.875,y_+300+40+20,start=0,extent=90,style="arc",outline="#333333")	

	can.create_line(xc-50+30,y_+300+40+10-1, xc-50+30,y_+300+100+30-10,fill="#333333")
	can.create_line(xc-50+30+10-1,y_+300+100+30, 555.875-10,y_+300+100+30,fill="#333333")
	can.create_line(555.875,y_+300+100+30-10, 555.875,y_+300+40+10-1,fill="#333333")
	can.create_line(555.875-10,y_+300+40, 555.875-340,y_+300+40,fill="#333333")
	...
	can.create_text(350,y_+250+30,text=str(int(difficulty)),font=("FreeMono",13),fill=col[0])
	...
	can.create_text(350,y_+yy-20, text="PLAY", font=("FreeMono",13),fill=col[0])
