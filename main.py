...
def main():
	...
	if con==1:
		...
		draw_transparent_bg(xx,yy,x_,y_,15,"#ffffff",0.9,1)

		can.create_text(x_+xx/2,y_+50,text=statement,font=("FreeMono",18))
		...
		can.create_oval(0+xv,y_+yy-20-30, 30+xv,y_+yy-20-30+30, fill="#222222",outline="#222222")
		can.create_rectangle(15+xv,y_+yy-20-30,sz-15+xv,y_+yy-20-30+30, fill="#222222",outline="#222222")
		can.create_oval(sz-30+xv,y_+yy-20-30, sz+xv,y_+yy-20-30+30, fill="#222222",outline="#222222")

		can.create_text(0+xv+sz/2,y_+yy-20-30+15, text="New Game",font=("FreeMono",13),fill="#ffffff")


		can.create_oval(0+xv+(xx-sz*2)/3+sz,y_+yy-20-30, 30+xv+(xx-sz*2)/3+sz,y_+yy-20-30+30, fill="#222222",outline="#222222")
		can.create_rectangle(15+xv+(xx-sz*2)/3+sz,y_+yy-20-30,sz-15+xv+(xx-sz*2)/3+sz,y_+yy-20-30+30, fill="#222222",outline="#222222")
		can.create_oval(sz-30+xv+(xx-sz*2)/3+sz,y_+yy-20-30, sz+xv+(xx-sz*2)/3+sz,y_+yy-20-30+30, fill="#222222",outline="#222222")

		can.create_text(0+xv+(xx-sz*2)/3+sz+sz/2,y_+yy-20-30+15, text="Quit",font=("FreeMono",13),fill="#ffffff")
	...
	if state=="transform_pawn":
		...
		can.create_text(350,y_+30,text="Transform Pawn",font=("FreeMono",14),fill="#000000")
		...
		can.create_oval(350-40-15,y_+yy-30-30, 350-40+15,y_+yy-30,fill="#222222",outline="#222222")
		can.create_rectangle(350-40,y_+yy-30-30, 350+40,y_+yy-30,fill="#222222",outline="#222222")
		can.create_oval(350+40-15,y_+yy-30-30, 350+40+15,y_+yy-30,fill="#222222",outline="#222222")

		can.create_text(350,y_+yy-30-30+15,text="OK",font=("FreeMono",13),fill="#ffffff")
		...
		can.create_text(350,y_+50,text="Are you sure you want to quit?",font=("FreeMono",14),fill="#000000")
		...
		can.create_text(0+xv+sz/2,y_+yy-20-30+15, text="YES",font=("FreeMono",13),fill="#ffffff")
		...
		can.create_text(0+xv+(xx-sz*2)/3+sz+sz/2,y_+yy-20-30+15, text="NO",font=("FreeMono",13),fill="#ffffff")
	...
	can.create_oval(700+5+15-16,5+15-16, 700+5+15+16-1,5+15+16-1,fill="#000000",outline="#000000")
	can.create_oval(700+5+15-16,5+15-16+30+5, 700+5+15+16-1,5+15+16-1+30+5,fill="#000000",outline="#000000")
...
def can_b1(e):
	...
	if state=="intro":
		...
		if 295+15<=e.x<=405-15:
			if 490+50<=e.y<=520+50:
				start_game()
						...
						def possible_moves(user_move):
							...
							for y in range(8):
								...
								for x in range(8):
									...
									elif stockfish.is_move_correct(p+"q")==True or stockfish.is_move_correct(p+"r")==True or stockfish.is_move_correct(p+"n")==True or stockfish.is_move_correct(p+"b")==True:
										pmoves.append(p)
	...
	if state=="quit" and qst==1:
		...
		if 167.33333333333331+15<=e.x<=317.3333333333333-15:
			if 375<=e.y<=405:
		...
		cx,cy=167.33333333333331+15,375+15
		...
		cx,cy=317.3333333333333-15,375+15
		...
		if 382.66666666666663+15<=e.x<=532.6666666666666-15:
			if 375<=e.y<=405:
		...
		cx,cy=382.66666666666663+15,375+15
		...
		cx,cy=532.6666666666666-15,375+15
...
def draw_pawn2(x,y,col):
	...
	can.create_arc(x1+(sz/2)-10*0.9090909091,y1+5*0.9090909091, x2-(sz/2)+10*0.9090909091,y1+25*0.9090909091, start=270,extent=180,fill=col,outline=col2,width=1 )
	can.create_arc(x1+(sz/2)-15*0.9090909091,y1+(25-3)*0.9090909091, x2-(sz/2)+15*0.9090909091,y1+(55-3)*0.9090909091, start=270,extent=180 ,fill=col,outline=col2,width=1 )
	can.create_arc(x1+(sz/2)-25*0.9090909091,y1+(55-6)*0.9090909091, x2-(sz/2)+25*0.9090909091,y1+(105-6)*0.9090909091,start=0,extent=90,fill=col,outline=col2,width=1 )
	
	can.create_arc(x1+(sz/2)+(-10+6)*0.9090909091-1+2,y1+(5+13)*0.9090909091, x2-(sz/2)+(10-6)*0.9090909091+1,y1+(25-12+13)*0.9090909091, start=270,extent=180 ,fill=col,outline=col,width=1 )
	can.create_arc(x1+(sz/2)+(-10+5)*0.9090909091-1+2,y1+(5+39)*0.9090909091, x2-(sz/2)+(10-5)*0.9090909091+1,y1+(25-8+39)*0.9090909091, start=270,extent=180 ,fill=col,outline=col,width=1 )





def draw_pawn1(x,y,col):
	global st,can
	...
	can.create_arc(x1+(sz/2)-10*0.9090909091,y1+5*0.9090909091, x2-(sz/2)+10*0.9090909091,y1+25*0.9090909091, start=90,extent=180,fill=col,outline=col2,width=1 )
	can.create_arc(x1+(sz/2)-15*0.9090909091,y1+(25-3)*0.9090909091, x2-(sz/2)+15*0.9090909091,y1+(55-3)*0.9090909091, start=90,extent=180 ,fill=col,outline=col2,width=1 )
	can.create_arc(x1+(sz/2)-25*0.9090909091,y1+(55-6)*0.9090909091, x2-(sz/2)+25*0.9090909091,y1+(105-6)*0.9090909091,start=90,extent=90,fill=col,outline=col2,width=1 )
	
	can.create_arc(x1+(sz/2)+(-10+6)*0.9090909091-1,y1+(5+13)*0.9090909091, x2-(sz/2)+(10-6)*0.9090909091+1-2,y1+(25-12+13)*0.9090909091, start=90,extent=180 ,fill=col,outline=col,width=1 )
	can.create_arc(x1+(sz/2)+(-10+5)*0.9090909091-1,y1+(5+39)*0.9090909091, x2-(sz/2)+(10-5)*0.9090909091+1-2,y1+(25-8+39)*0.9090909091, start=90,extent=180 ,fill=col,outline=col,width=1 )
...
def sel(x,y):
	...
	can.create_arc(0+x,0+y,20+x,20+y,style="arc",outline=col[1],width=2,start=90,extent=90)
	can.create_arc(82.5-20-1+x,0+y,82.5-1+x,20+y,style="arc",outline=col[1],width=2,start=0,extent=90)
	can.create_arc(0+x,82.5-20-1+y,20+x,82.5-1+y,style="arc",outline=col[1],width=2,start=180,extent=90)
	can.create_arc(82.5-20-1+x,82.5-20-1+y,82.5-1+x,82.5-1+y,style="arc",outline=col[1],width=2,start=270,extent=90)

	can.create_line(10+x,1+y, 82.5-10-1+x,1+y,fill=col[1],width=2)
	can.create_line(10+x,82.5-1+y, 82.5-10-1+x,82.5-1+y,fill=col[1],width=2)

	can.create_line(1+x,10+y, 1+x,82.5-10-1+y,fill=col[1],width=2)
	can.create_line(82.5-1+x,10+y, 82.5-1+x,82.5-10-1+y,fill=col[1],width=2)
...
def scale_difficulty():
	...
	can.create_oval(x+xx-3,y_+250-12, x+xx+3,y_+250-12+6,fill="#222222",outline="#222222")
	can.create_oval(x+xx-3,y_+250+12-6, x+xx+3,y_+250+12,fill="#222222",outline="#222222")
	can.create_rectangle(x+xx-3,y_+250-12+3, x+xx+3,y_+250+12-3,fill="#222222",outline="#222222")
...
def intro():
	...
	can.create_text(x_+xx/2,y_+40,text="Choose Side!",font=("FreeMono",14),anchor="c")
	...
	can.create_text(x_+xv,y_+220,text="Difficulty",font=("FreeMono",13),anchor="w")


	can.create_line(x_+xv,y_+250, x_+xx-xv,y_+250,fill="#222222",width=2)
	...
	can.create_text(x_+xv,y_+330,text="Theme",font=("FreeMono",13),anchor="w")
	...
	if bg_sel==1:
		can.create_rectangle(xc-3,y_+360-3, xc+w+3,y_+360+w/2+3)

	elif bg_sel==2:
		can.create_rectangle(xc+xc2*2+w-3,y_+360-3, xc+xc2*2+w*2+3,y_+360+w/2+3)

	elif bg_sel==3:
		can.create_rectangle(xc+371.75-w-6,y_+360-3, xc+371.75,y_+360+w/2+3)
	...
	can.create_text(350,y_+250+30,text=str(int(difficulty)),font=("FreeMono",13))


	can.create_rectangle(350-40,y_+yy-30-30, 350+40,y_+yy-30,fill="#222222",outline="#222222")
	can.create_oval(350-40-15,y_+yy-30-30, 350-40+15,y_+yy-30-30+30,fill="#222222",outline="#222222")
	can.create_oval(350+40-15,y_+yy-30-30, 350+40+15,y_+yy-30-30+30,fill="#222222",outline="#222222")

	can.create_text(350,y_+yy-30-30+15, text="PLAY", font=("FreeMono",13),fill="#ffffff")
...
can=tk.Canvas(width=740,height=700,bg="#222222",relief="flat",highlightthickness=0,border=0)
